...
export default function CamelBadge({
  children,
  variant = 'default',
  icon = null,
  className = ''
  ...
  return (
    <span
      className={clsx(
        'inline-flex items-center gap-1.5 px-3 py-1 rounded-sm border-2 font-display font-bold text-xs uppercase tracking-wider',
        variants[variant],
        className
      )}
    >
